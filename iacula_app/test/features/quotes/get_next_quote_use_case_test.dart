...
void main() {
  test(
    'call omits liturgicalSeasonEnabled does not touch liturgical service',
    () async {
  ...
  test(
    'fetchBatch omits liturgicalSeasonEnabled does not touch liturgical service',
    () async {
      final useCase = GetNextQuoteUseCase(
        contentRepository: _FakeQuoteContentRepository(
          quotes: {
  ...
  test(
    'fetchBatch uses day pool per scheduled instant across midnight',
    () async {
      final repo = _FakeIndicesRepository();
