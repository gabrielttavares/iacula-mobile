...
void main() {
  test(
    ...
    () async {
      ...
      final settings = Settings.defaults.copyWith(language: 'pt-br');
  ...
  test('Angelus stays Angelus during Easter', () async {
    final scheduler = InMemoryNotificationSchedulerRepository();
    final history = _InMemoryNotificationHistoryRepository();
    ...
    await useCase(
      Settings.defaults.copyWith(angelusEnabled: true),
  ...
  test('Angelus does not use local Easter fallback', () async {
    final scheduler = InMemoryNotificationSchedulerRepository();
    final history = _InMemoryNotificationHistoryRepository();
